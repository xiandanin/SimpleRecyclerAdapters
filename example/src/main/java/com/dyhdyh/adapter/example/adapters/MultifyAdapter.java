...
public class MultifyAdapter extends BaseRecyclerAdapter<ItemInfo, RecyclerView.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, ItemInfo item) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType==VIEWTYPE_TIME){
            ...
            return new FromViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_databinding_multify_from, parent, false));
        } else {
